...
export default function AboutPanel() {
  return (
    <div className="about-panel absolute inset-0 z-20 pointer-events-none p-4 sm:p-6">
      <div className="about-panel-inner relative w-full h-full max-w-6xl mx-auto pointer-events-auto">
        {/* 卡片一：照片 + 个人信息 — 左上 */}
        <motion.div
          className="about-card glass p-6 sm:p-8 absolute left-0 top-[6%] w-80 sm:w-[26rem]"
        ...
        >
          <div className="flex flex-col items-center text-center gap-5">
            <div className="w-40 h-40 rounded-full overflow-hidden ring-2 ring-white/20">
              <img src="/avatar1.jpg" alt="LvkkSyringa" className="w-full h-full object-cover" />
            </div>
            <div>
        ...
        {/* 卡片二：宣言 + 兴趣 + 社交媒体 — 左下 */}
        <motion.div
          className="about-card glass p-6 sm:p-8 absolute left-0 bottom-[4%] w-[22rem] sm:w-[30rem]"
          initial={{ opacity: 0, y: 40 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        {/* 卡片三：梦想 + slogan — 右侧 */}
        <motion.div
          className="about-card glass p-6 sm:p-8 absolute right-[-1.5rem] top-[28%] w-80 sm:w-[26rem]"
          initial={{ opacity: 0, y: 40 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <p className="text-lg leading-relaxed text-white/60 mb-6">
            Establish a little studio and develop more interesting and meaningful games with my friends.
          </p>
